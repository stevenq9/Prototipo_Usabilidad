...
function Footer() {
    return (
        <footer tabIndex="0" class="container-fluid float-start txt_primario">
            <div class="row mt-3 ms-5 me-5 text-center">
                <div class="col-2 ms-5">
                    <h4 tabIndex="1">Sobre Cinemark</h4>
                    <h5 tabIndex="2">¿Quiénes somos?</h5>
                    <h5 tabIndex="3">Términos y condiciones</h5>
                </div>
                <div class="col-2">
                    <h4 tabIndex="4">Contáctanos</h4>
                    <h5 tabIndex="5">Pqrs</h5>
                </div>
                <div class="col-2">
                    <h4 tabIndex="6">Marketing empresarial</h4>
                    <h5 tabIndex="7">Servicios</h5>
                </div>

                <div class="col-3">
                    <h4 tabIndex="8">Descarga nuestra App</h4>
                    <div class="row d-flex justify-content-between ms-4">
                        <div class="col-4 ">
                            <img tabIndex="9" className="img_descarga" src={require('../logos/PlayStore.png')} alt="Clic para descargar app por PlayStore" />
                        </div>
                    </div>
                </div>
                <div class="col-2">
                    <div className="row">
                        <div className="logo bg_primario d-flex justify-content-center">
                            <a tabIndex="10" href="https://www.facebook.com/CinemarkEcuador/?locale=es_LA" alt="Enlace página de Facebook de Cinemark">
                        ...
                        <div className="logo bg_primario d-flex justify-content-center">
                            <a tabIndex="11" href="https://www.instagram.com/cinemarkec/?hl=es-la" alt="Enlace perfil Instagram Cinemark">
                        ...
                        <div className="logo bg_primario d-flex justify-content-center">
                            <a tabIndex="12" href="https://twitter.com/CinemarkEC" alt="Enlace perfil Twitter de Cinemark">
