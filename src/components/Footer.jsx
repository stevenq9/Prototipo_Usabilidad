                ...
                <div class="col-2">
                    <div className="row">
                        <div className="logo bg_primario d-flex justify-content-center">
                            <a role="link" tabIndex="0" href="https://www.facebook.com/CinemarkEcuador/?locale=es_LA" alt="Enlace página de Facebook de Cinemark">
                        ...
                        <div className="logo bg_primario d-flex justify-content-center">
                            <a role="link" tabIndex="0" href="https://www.instagram.com/cinemarkec/?hl=es-la" alt="Enlace perfil Instagram Cinemark">
                                <svg role="img" aria-label="Enlace página de Instragram de Cinemark" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" >
                        ...
                        <div className="logo bg_primario d-flex justify-content-center">
                            <a role="link" tabIndex="0" href="https://twitter.com/CinemarkEC" alt="Enlace perfil Twitter de Cinemark">
