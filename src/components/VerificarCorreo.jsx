        ...
        return (
            <div id="VerificarCorreo" className="position-absolute top-0 end-0 ">
                <div id='formVerificar' className='row d-flex align-items-center formulario bg_primario ps-5 pt-2 pb-2 pe-5'>
                    <h1 role='navigation' tabIndex="0" className="txt_auxiliar fw-bold text-center">VERIFICACIÓN CORREO</h1>
                    <h4 role='navigation' tabIndex="0" className="txt_primario fs-5 text-center">ESTIMADO USUARIO</h4>
                    <h4 role='navigation' tabIndex="0" className="txt_primario fs-5 text-center">Hemos enviado un código de verificación al correo proporcionado.
                        Ingrésalo para verificar tu cuenta
                    </h4>
                    <h5 role='navigation' tabIndex="0" className="row text-center">No olvides revisar tu bandeja de Spam si el correo no aparece</h5>
                    <input type="number" placeholder="CÓDIGO" />
                    <div className="row">
                        <div className="col-6 txt_auxiliar" role='navigation' tabIndex="0">
                            Vence en {minutos < 10 ? '0' + minutos : minutos}:{segundos < 10 ? '0' + segundos : segundos}
                        </div>
                        <div className="col-6 txt_auxiliar text-end" role='navigation' tabIndex="0">
                            Reenviar código
                        </div>
                    </div>
                    <div className='row'>
