...
function Encabezado() {
  return (
      <header className="encabezado row d-flex align-items-center bg_secundario">
        <div className="col-3">
          <div className="row d-flex justify-content-center">
            <div  className="col-3 logo bg_primario d-flex justify-content-center" >
              <a tabIndex="1" title='Enlace página de Facebook de Cinemark' href="https://www.facebook.com/CinemarkEcuador/?locale=es_LA">
                <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg" alt="Enlace página de Facebook de Cinemark">
            ...
            <div className="col-3 logo bg_primario d-flex justify-content-center">
              <a tabIndex="2" href="https://www.instagram.com/cinemarkec/?hl=es-la">
                <svg  alt="Enlace perfil Instagram Cinemark"  width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" >
            ...
            <div className="col-3 logo bg_primario d-flex justify-content-center" >
              <a tabIndex="3" href="https://twitter.com/CinemarkEC">
                <svg alt="Enlace perfil Twitter de Cinemark" width="25" height="25" viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg" >
        ...
        <div  className="col-5 d-flex justify-content-around txt_secundario">
          <ul tabIndex="4">
            <li tabIndex="5">Tarifas</li>
            <li tabIndex="6">Conocenos</li>
            <li tabIndex="7">Formatos</li>
            <li tabIndex="8">Marketing</li>
          </ul>
        </div>
        <div className="col-4 d-flex justify-content-end">
          <div className="row txt_primario">
            <div className="col-4 boton bg_primario d-flex align-items-center">
              <Link tabIndex="9" to="/registro" className='links text-center txt_primario'>REGISTRARSE</Link>
            </div>
            <div className=" col-4 boton bg_terciario d-flex align-items-center me-4">
              <Link tabIndex="10" to="/iniciarSesion" className='links text-center txt_primario'>INICIAR SESIÓN</Link>
            </div>
          </div>
        </div>
      </header>
