        ...
        <div id='Registro' className='bg_primario'>
            ...
            <div id='registro' className='row d-flex justify-content-center'>
                <form className='row formulario d-flex align-items-center bg_auxiliar mt-4 ps-5 pt-2 pb-2 pe-5'>
                    <h1 role='navigation' tabIndex="0" className='text-center txt_primario fw-bold'>REGISTRO</h1>
                    <div>
                        <label role='navigation' tabIndex="0" className='col-2' htmlFor="nombre">Nombre:</label>
                        <input required type="text" id="nombre" className='bg_secundario col-10' placeholder='Escribe tu nombre' />
                    </div>
                    <div>
                        <label role='navigation' tabIndex="0" className='col-2' htmlFor="apellido">Apellido:</label>
                    ...
                    <span role='navigation' tabIndex="0" >O continua con:</span>
                    <div>
