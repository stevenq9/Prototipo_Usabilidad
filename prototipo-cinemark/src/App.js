  ...
  return (
    <Router>
      <div className="App">
        ...
        <Menu />
        <Banner />
        <section className='row ms-5 mt-3 txt_primario d-flex align-items-center'>
          <div className="col-2">
            Usted está en:
          </div>
          <div className="col-1">
            <select name='ubicacionUsuario' className='txt_auxiliar'>
        ...
        <div class="row ms-5 me-5 d-flex justify-content-around">
          <div className='col-1 control_cartelera d-flex align-items-center'>
            <svg width="2" height="28" viewBox="0 0 18 28" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='row d-flex justify-content-center'>
          <div className='bg_terciario btn txt_primario'>
        ...
        <section className='mt-4 ms-5 me-5'>
          ...
          <div className='row me-5 d-flex justify-content-around'>
            ...
            <div className='btn_bordes btn txt_primario'>
              Contenido IMAX
            </div>
            <div className='btn_bordes btn txt_primario '>
              Contenido PREMIER
            </div>
            <div className='btn_bordes btn txt_primario me-5'>
              Contenido XD
            </div>
          </div>
          ...
          <div id='DBOX' class="row me-5 mt-4">
            ...
            <img id='img_dbox' src={require('./images/Recomendados.png')} alt='Imagen promocional experiencia DBOX Cinemark'></img>
            <div id="dbox_info" class="bg_terciario btn">
              MÁS INFORMACIÓN
            </div>
            <img id='transformes_dbox' src={require('./images/transformersPelicula.jpg')} alt='Imagen promocional Transformes DBOX Cinemark'></img>
          </div>
        </section>
        ...
        <section class="mt-4 ms-5 pb-4">
          ...
          <div className='row mt-2 me-5 d-flex justify-content-around'>
            <div class="col-4">
              <img className='img_promocion' src={require('./images/promocion1.png')} alt='Promocion Challenge 2K y 5L Cinemark'></img>
            </div>
            <div class="col-4">
              <img className='img_promocion' src={require('./images/promocion2.png')} alt='Promoción 505 de descuento presentando tajerta Cinemark'></img>
            </div>
          </div>
        </section>
