        ...
        <div className="col-3">
          <div className="row d-flex justify-content-center">
            <div className="col-3 logo bg_primario d-flex justify-content-center">
              <a href="https://www.facebook.com/CinemarkEcuador/?locale=es_LA">
            ...
            <div className="col-3 logo bg_primario d-flex justify-content-center">
              <a href="https://www.instagram.com/cinemarkec/?hl=es-la">
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" alt="Enlace perfil Instagram Cinemark">
            ...
            <div className="col-3 logo bg_primario d-flex justify-content-center">
              <a href="https://twitter.com/CinemarkEC">
                <svg width="25" height="25" viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg" alt="Enlace perfil Twitter de Cinemark">
        ...
        <div className="col-4 d-flex justify-content-end">
          <div className="row txt_primario">
            <div className="col-4 boton bg_primario d-flex align-items-center">
              <span to="/registro" className='text-center'>REGISTRARSE</span>
            </div>
            <div className="col-4 boton bg_terciario d-flex align-items-center me-4">
              <span to="/inicioSesion" className='text-center'>INICIAR SESIÓN</span>
            </div>
          </div>
        </div>
      </header>
